package com.example.lapane_skm.ui.question.fragment_13
...
import com.example.lapane_skm.ui.question.fragment_12.Question12Fragment
import com.example.lapane_skm.ui.question.fragment_14.Question14Fragment
 ...
 *
 */
class Question13Fragment : BaseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        isDataQuestion = activity?.let { PrefSaveQuestion13(it).getData().toString() }.toString()
        Log.e("data ", "data question 13 $isDataQuestion")
        ...
        tv_prev.setOnClickListener {
            openFragment(Question12Fragment())
        }



        tvNext?.setOnClickListener {
            openFragment(Question14Fragment())
    ...
    private fun initData() {
        tvNo?.text ="13"
        tvQuestion?.text ="Penanganan pengaduan pengguna layanan yang diberikan?"
        ...
        val adapter = Jabawan13Adapter(activity, data)
        rvDataQuestion?.adapter = adapter
        adapter.notifyDataSetChanged()

        adapter.setOnItemClickListener(object : Jabawan13Adapter.OnItemClickListener {
            override fun onItemClick(position: Int) {
                activity?.let { PrefSaveQuestion13(it).setData(data.get(position).id.toString()) }
                openFragment(Question14Fragment())
