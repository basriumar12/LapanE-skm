...
import com.example.lapane_skm.save.PrefSaveQuestion10
...
class Jabawan10Adapter (var context: Context?, var list: List<ModelSatuanKerja>) :
    RecyclerView.Adapter<Jabawan10Adapter.ViewHolder>() {
...
//    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val dataCheckImage = context?.let { PrefSaveQuestion10(it).getData() }
        Log.e("tag","data 10 $dataCheckImage adapter")
