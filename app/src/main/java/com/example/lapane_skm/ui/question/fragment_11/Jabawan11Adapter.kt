...
import com.example.lapane_skm.save.PrefSaveQuestion11
...
class Jabawan11Adapter (var context: Context?, var list: List<ModelSatuanKerja>) :
    RecyclerView.Adapter<Jabawan11Adapter.ViewHolder>() {
...
//    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val dataCheckImage = context?.let { PrefSaveQuestion11(it).getData() }
        Log.e("tag","data 11 $dataCheckImage adapter")
