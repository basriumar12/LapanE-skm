package com.example.lapane_skm.ui.question.fragment_7
 ...
 *
 */
class Question7Fragment : BaseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        isDataQuestion = activity?.let { PrefSaveQuestion7(it).getData().toString() }.toString()
        Log.e("data ", "data question 7 $isDataQuestion")
    ...
    private fun initData() {
        tvNo?.text ="7"
        tvQuestion?.text ="Kesesuaian persyaratan pelayanan yang diberikan?  *"
