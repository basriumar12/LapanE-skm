...
import com.example.lapane_skm.save.PrefSaveQuestion13
...
class Jabawan13Adapter (var context: Context?, var list: List<ModelSatuanKerja>) :
    RecyclerView.Adapter<Jabawan13Adapter.ViewHolder>() {
...
//    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val dataCheckImage = context?.let { PrefSaveQuestion13(it).getData() }
        Log.e("tag","data 13 $dataCheckImage adapter")
