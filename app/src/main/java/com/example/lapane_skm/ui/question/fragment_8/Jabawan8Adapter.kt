...
class Jabawan8Adapter (var context: Context?, var list: List<ModelSatuanKerja>) :
    RecyclerView.Adapter<Jabawan8Adapter.ViewHolder>() {
...
//    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val dataCheckImage = context?.let { PrefSaveQuestion8(it).getData() }
        Log.e("tag","data 8 $dataCheckImage adapter")
