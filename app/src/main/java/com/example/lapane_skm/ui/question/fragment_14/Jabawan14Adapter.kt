...
import com.example.lapane_skm.save.PrefSaveQuestion14
...
class Jabawan14Adapter (var context: Context?, var list: List<ModelSatuanKerja>) :
    RecyclerView.Adapter<Jabawan14Adapter.ViewHolder>() {
...
//    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val dataCheckImage = context?.let { PrefSaveQuestion14(it).getData() }
        Log.e("tag","data 14 $dataCheckImage adapter")
