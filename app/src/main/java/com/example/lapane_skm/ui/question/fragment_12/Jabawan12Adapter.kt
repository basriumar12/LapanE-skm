...
import com.example.lapane_skm.save.PrefSaveQuestion12
...
class Jabawan12Adapter (var context: Context?, var list: List<ModelSatuanKerja>) :
    RecyclerView.Adapter<Jabawan12Adapter.ViewHolder>() {
...
//    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val dataCheckImage = context?.let { PrefSaveQuestion12(it).getData() }
        Log.e("tag","data 12 $dataCheckImage adapter")
