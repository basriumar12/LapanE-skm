...
class JabawanLimaAdapter (var context: Context?, var list: List<ModelSatuanKerja>) :
    RecyclerView.Adapter<JabawanLimaAdapter.ViewHolder>() {
...
//    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val dataCheckImage = context?.let { PrefSaveQuestionLima(it).getData() }
        Log.e("tag","data 5 $dataCheckImage adapter")
